...
class directResize {
	...
	function directResize($drconfig, $input)
	{
		...
		// Ìàññèâ äëÿ ñêëàäèðîâàíèÿ óæå îáðàáîòàííûõ èìåí ôàéëîâ. Ñëóæèò äëÿ ïåðåèìåíîâàíèÿ ôàéëîâ ñ îäèíàêîâûìè èìåíàìè íî èç ðàçíûõ èñòî÷íèêîâ â îäíîì äîêóìåíòå
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Ôóíêöèÿ ñîçäàíèÿ ëîêàëüíûõ êîïèé ôàéëîâ ñ óäàëåííûõ ñåðâåðîâ.
	Ïðîâåðÿåò, ñóùåñòâóåò ëè ëîêàëüíàÿ êîïèÿ äàííîãî ôàéëà, ïðîâåðÿåò âðåìÿ ïîñëåäíåãî îáíîâëåíèÿ ôàéëà è ñðàâíèâàåò ñ $drconfig['remote_refresh_time']
	Â ñëó÷àå íåîáõîäèìîñòè - êîïèðóåò ôàéë ñ óäàëåííîãî ñåðâåðà è ñîçäàåò ëîêàëüíóþ êîïèþ, êîòîðàÿ èñïîëüçóåòñÿ â ïîñëåäñòâèè äëÿ ãåíåðàöèè òóìá
	*/
	function CheckRemoteImg($imgFile)
	{
		...
		/*
		 Ñðàâíèâàåì ðàçìåðû óäàëåííîãî ôàéëà ñ ëîêàëüíîé êîïèåé, åñëè âûñîòà èëè øèðèíà íå ñîâïàäàþò - çàêà÷èâàåì ôàéë çàíîâî
		 Åñëè ñîâïàäàþò, ìåíÿåì âðåìÿ èçìåíåíèÿ ôàéëà íà òåêóùåå
		*/
		if ($update)
		{
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Ôóíêöèÿ äëÿ îïðåäåëåíèÿ ðàçìåðîâ ãåíåðèðóåìîãî èçîáðàæåíèÿ, áàçèðóþùàÿñÿ íà ïàðàìåòðàõ øèðèíû imgWidth  è/èëè âûñîòû imgHeight è ìåòîäà èçìåíåíèÿ ðàçìåðà èçîáðàæåíèÿ resize_method
	resize_method ïðèíèìàåò çíà÷åíèå îò 0 äî 3, âî âñåõ ñëó÷àÿõ ïðîïîðöèè èçîáðàæåíèÿ ñîõðàíÿþòñÿ
	
	0 - èçîáðàæåíèå ñíà÷àëà óìåíüøàåòñÿ, çàòåì îáðåçàåòñÿ òàê, ÷òîáû âïèñàòüñÿ â ïðÿìîóãîëüíèê imgWidth õ imgHeight
	1 - ïî çàäàííîé øèðèíå àâòîìàòè÷åñêè âû÷èñëÿåòñÿ âûñîòà èçîáðàæåíèÿ
	2 - ïî çàäàííîé âûñîòå àâòîìàòè÷åñêè âû÷èñëÿåòñÿ øèðèíà èçîáðàæåíèÿ
	3 - èçîáðàæåíèå óìåíüøàåòñÿ òàêèì îáðàçîì ÷òîáû íå ïðåâûøàòü çàäàííûå imgWidth è imgHeight
	*/
	function CalcSizes()
	{
		global $modx;
	...
	/*
	Ïðîâåðÿåì:
	//- ñóùåñòâóåò ëè öåëåâàÿ ïàïêà img_target_dir
	- çàäàíû ëè âûñîòà èëè øèðèíà ãåíåðèðóåìîãî èçîáðàæåíèÿ
	- íå ðàâíû ëè çàäàííûå âûñîòà è ùèðèíà ãåíåðèðóåìîãî èçîáðàæåíèÿ ðåàëüíûì âûñîòå è øèðèíå èñõîäíîãî èçîáðàæåíèÿ (íóæíî ëè âîîáùå ãåíåðèðîâàòü èçîáðàæåíèå)
	*/
	function Verify()
	{
		global $modx;
	...
	/*
	Ïðîâåðÿåì:
	-  ñóùåñòâóåò ëè óæå ñãåíåðèðîâàííîå ðàíåå èçîáðàæåíèå ïî çàäàííîìó ïóòè ñ äàííûìè âûñîòîé è øèðèíîé
	*/
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Íàíîñèì âîäÿíûå çíàêè åñëè íåîáõîäèìî
	*/
	function ApplyWatermark($watermark)
	{
		...
		// Ñïåöèàëüíûé âîäÿíîé çíàê äëÿ WYSIWYG-ðåäàêòîðà
		if ($modx->isBackend()) 
		{
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Ïðîâåðÿåì ðàçðåøåííûå ðàñøèðåíèÿ äëÿ èçîáðàæåíèé
	*/	
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Ïðîâåðÿåì ðàçðåøåííûå è çàïðåùåííûå ïóòè äëÿ ïðèìåíåíèÿ ïëàãèíà
	*/
	function checkPath($path)
	{
		global $modx;
		
		// Ïóòü - àáñîëþòíûé, óêàçàí ÷åðåç /
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Óäàëÿåì ìåòêè èç âûõîäíîãî êîäà
	*/
	...
	*/
	...
	function ProcessContent($o)
	{
		...
		for($n=0;$n<count($imgs[0]);$n++){
			...
			//ïðîâåðÿåì, ìîæíî ëè äëÿ èçîáðàæåíèÿ â åãî ïàïêå èñïîëüçîâàòü ïëàãèí, ïðîâåðÿåì ìåòêó drskip, ïðîâåðÿåì ðàñøèðåíèå ôàéëà
			...
			if ($this->checkPath($currentImgPath) && !$this->label["drskip"] && $this->CheckAllowedExt($currentImgPath) && (($this->drconfig['lightbox_mode'] == 1 && $this->label["drlightbox"]) || $this->drconfig['lightbox_mode'] == 2)){									
				...
				// ïðîâåðÿåì, çàäàíû ëè ó èçîáðàæåíèÿ height èëè width
				if ($this->CheckThumbSizes($img)){
					...
					/*
					thumbImgTag - HTML-êîä òåãà img äëÿ òóìáû
					thumbWidth, thumbHeight - ôèíàëüíûå ðàçìåðû ñãåíåðèðîâàííîé òóìáû
					*/
					...
					// Ãåíåðèðóåì áîëüøîå èçîáðàæåíèå è lightbox HTML-êîä
					if (!$modx->isBackend() && !$this->label["drthumbonly"]){	
						...
						if ($currentImgWidth > $this->imgHTMLWidth || $currentImgHeight > $this->imgHTMLHeight){
							...
							if ($currentImgWidth > $this->drconfig['big_width'] || $currentImgHeight > $this->drconfig['big_height']){
								// Ãåíåðèðóåì áîëüøîå èçîáðàæåíèå
							...
							// Ãåíåðèðóåì HTML-êîä lightbox-ññûëêè
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Ïàðñèì øàáëîí, ñîáèðàåì âûõîäíîé êîä
	*/
	function ParseTemplate($tpl, $currId)
	{
		...
		/*
		Îáðàáàòûâàåì àòòðèáóòû èñõîäíîãî èçîáðàæåíèÿ, ïîìåùàåì èõ â ïëåéñõîëäåðû
		*/
		$HTMLattr = array(
			"alt" 		=>	"alt|Alt|ALT", 
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Ïðîâåðÿåì, ñóùåñòâóåò ëè ïàïêà, åñëè íåò - ñîçäàåì åå â çàâèñèìîñòè îò çàäàííûõ ïàðàìåòðîâ (ñòàíäàðòíûìè ñðåäñòâàìè PHP èëè ÷åðå FTP-êîìàíäû)
	*/
	function CreateDir()
		{
			global $modx;
	...
	//-------------------------------------------------------------------------------------------------
	/*
	Ïîäêëþ÷àåì JS è CSS îò Maxigallery.
	*/
